      ...
      <>
        {!reply ? (
          <div className="flex items-start mb-8 space-x-4">
            ...
            <form className="flex-1 flex flex-col" onSubmit={onSubmitComment}>
              <div className="flex-1 flex relative justify-center">
                ...
                <div
                  ...
                  ${
                    focus
                      ? "h-[2px] -bottom-[1px]"
                      : "h-[1px] -bottom-0 bg-gray-500 dark:bg-gray-400"
                  } 
              ...
              {active && (
                <div className="mt-2 self-end flex space-x-2 text-sm font-medium">
                  ...
                  <button
                    className={`py-[10px] px-5 rounded uppercase ${
                      text.length
                        ? "bg-blue-500 text-white"
                        : "bg-gray-100 dark:bg-dark2 text-secondary"
                    }`}
                  >
          ...
          <div className="flex items-start space-x-4 mt-1">
            {user ? (
              ...
              <div className="material-symbols-outlined fill-1 text-[32px] flex justify-center items-center">
                account_circle
              </div>
            )}
    ...
    <form onSubmit={reply ? onSubmitReply : onSubmitComment}>
      <div className="flex mb-0 space-x-2">
        {user ? (
          ...
          <div className="material-symbols-outlined fill-1 text-[40px] flex-shrink-0 md:text-[48px] flex justify-center items-center">
            account_circle
          </div>
        )}
        <div className="flex-1 relative flex items-center">
          <input
            ...
            ref={inputRefMobile}
          />
          <button className="absolute inset-y-0 right-0 w-10 flex items-center">
            <span className="material-symbols-outlined fill-1 text-2xl absolute right-3">
              send
            </span>
          </button>
        </div>
